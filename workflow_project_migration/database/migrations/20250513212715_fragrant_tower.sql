...
('design', 4, 'Video Script', 'Generate the script and scene descriptions for any required marketing videos'),
('design', 5, 'Video Production', 'Generate and edit the primary marketing video'),
