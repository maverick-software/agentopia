 ...
 */
function isAxiosErrorWithResponse(error: any): error is { response: { status: number; data?: {id?: string; message?: string; code?: string; [key: string]: any} }; message: string; code?: string; isAxiosError?: boolean } {
