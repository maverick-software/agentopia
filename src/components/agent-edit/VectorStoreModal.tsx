...
export const VectorStoreModal: React.FC<VectorStoreModalProps> = ({
  ...
  const connectedStore = vectorStores.find(ds => ds.id === selectedVectorStore);
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Select or create a vector datastore for similarity search.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-4 py-4">
          ...
          {loadingAvailable ? (
            <p className="text-center text-muted-foreground">Loading vector stores...</p>
          ) : (
