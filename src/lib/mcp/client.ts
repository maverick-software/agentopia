...
export class MCPClient {
    ...
    // Optional helper method to persist capabilities (logging example)
    /*
    private async persistCapabilities(capabilities: MCPServerCapabilities): Promise<void> {
        try {
             console.log(`${this.logPrefix} Persisting capabilities to database...`, capabilities);
            // ... database update logic ...
             console.log(`${this.logPrefix} Capabilities persisted successfully.`);
        } catch (dbError) {
            console.error(`${this.logPrefix} Exception persisting capabilities:`, dbError);
        }
    }
    */
} 