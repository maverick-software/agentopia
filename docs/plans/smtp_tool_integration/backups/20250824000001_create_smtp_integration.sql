...
-- =============================================
-- STEP 1: Create SMTP Provider in OAuth Providers
-- =============================================

INSERT INTO oauth_providers (name, display_name, provider_type, is_active, configuration) 
VALUES (
    'smtp',
    'SMTP Email',
    'api_key',
    true,
    '{
        "description": "General SMTP email integration for autonomous email sending",
...
-- =============================================
-- STEP 2: Create SMTP Configurations Table
-- =============================================
...
-- =============================================
-- STEP 3: Create Agent SMTP Permissions Table
-- =============================================
...
-- =============================================
-- STEP 4: Create SMTP Operation Logs Table
-- =============================================
...
-- =============================================
-- STEP 8: Create Secure Vault Functions
-- =============================================
