...
CREATE TABLE IF NOT EXISTS "public"."agent_mcp_connection_logs" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "timestamp" timestamp with time zone DEFAULT "now"() NOT NULL,
    "created_by" "uuid",
    CONSTRAINT "agent_mcp_connection_logs_event_type_check" CHECK (("event_type" = ANY (ARRAY['connect'::"text", 'disconnect'::"text", 'error'::"text", 'test'::"text", 'status_change'::"text"])))
);


ALTER TABLE "public"."agent_mcp_connection_logs" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."agent_mcp_connections" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "agent_id" "uuid" NOT NULL,
    "mcp_server_instance_id" "uuid" NOT NULL,
...
COMMENT ON TABLE "public"."agent_mcp_connections" IS 'Connections between user agents and admin-deployed MCP servers';
...
CREATE TABLE IF NOT EXISTS "public"."mcp_server_status_logs" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "timestamp" timestamp with time zone DEFAULT "now"() NOT NULL,
    "created_by" "uuid",
    CONSTRAINT "mcp_server_status_logs_source_check" CHECK (("source" = ANY (ARRAY['dtma'::"text", 'heartbeat'::"text", 'manual'::"text", 'system'::"text"])))
);


ALTER TABLE "public"."mcp_server_status_logs" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."agent_mcp_connection_logs"
    ADD CONSTRAINT "agent_mcp_connection_logs_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."agent_mcp_connections"
    ADD CONSTRAINT "agent_mcp_connections_agent_id_mcp_server_instance_id_key" UNIQUE ("agent_id", "mcp_server_instance_id");
...
ALTER TABLE ONLY "public"."mcp_server_status_logs"
    ADD CONSTRAINT "mcp_server_status_logs_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_agent_mcp_connection_logs_connection_id" ON "public"."agent_mcp_connection_logs" USING "btree" ("connection_id");



CREATE INDEX "idx_agent_mcp_connection_logs_timestamp" ON "public"."agent_mcp_connection_logs" USING "btree" ("timestamp");



CREATE INDEX "idx_agent_mcp_connections_agent_id" ON "public"."agent_mcp_connections" USING "btree" ("agent_id");



CREATE INDEX "idx_agent_mcp_connections_is_active" ON "public"."agent_mcp_connections" USING "btree" ("is_active");



CREATE INDEX "idx_agent_mcp_connections_mcp_server_instance_id" ON "public"."agent_mcp_connections" USING "btree" ("mcp_server_instance_id");
...
CREATE INDEX "idx_mcp_server_status_logs_server_id" ON "public"."mcp_server_status_logs" USING "btree" ("server_id");



CREATE INDEX "idx_mcp_server_status_logs_timestamp" ON "public"."mcp_server_status_logs" USING "btree" ("timestamp");
...
CREATE OR REPLACE TRIGGER "trigger_agent_mcp_connections_updated_at" BEFORE UPDATE ON "public"."agent_mcp_connections" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_set_timestamp"();
...
ALTER TABLE ONLY "public"."agent_mcp_connection_logs"
    ADD CONSTRAINT "agent_mcp_connection_logs_connection_id_fkey" FOREIGN KEY ("connection_id") REFERENCES "public"."agent_mcp_connections"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."agent_mcp_connection_logs"
    ADD CONSTRAINT "agent_mcp_connection_logs_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id");
...
ALTER TABLE ONLY "public"."agent_mcp_connections"
    ADD CONSTRAINT "agent_mcp_connections_mcp_server_instance_id_fkey" FOREIGN KEY ("mcp_server_instance_id") REFERENCES "public"."account_tool_instances"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."mcp_server_status_logs"
    ADD CONSTRAINT "mcp_server_status_logs_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."mcp_server_status_logs"
    ADD CONSTRAINT "mcp_server_status_logs_server_id_fkey" FOREIGN KEY ("server_id") REFERENCES "public"."account_tool_instances"("id") ON DELETE CASCADE;
...
CREATE POLICY "System can insert connection logs" ON "public"."agent_mcp_connection_logs" FOR INSERT WITH CHECK (true);



CREATE POLICY "System can insert status logs" ON "public"."mcp_server_status_logs" FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Users can view relevant status logs" ON "public"."mcp_server_status_logs" FOR SELECT USING (("server_id" IN ( SELECT DISTINCT "amc"."mcp_server_instance_id"
   FROM ("public"."agent_mcp_connections" "amc"
     JOIN "public"."agents" "a" ON (("amc"."agent_id" = "a"."id")))
...
CREATE POLICY "Users can view their own connection logs" ON "public"."agent_mcp_connection_logs" FOR SELECT USING (("connection_id" IN ( SELECT "amc"."id"
   FROM ("public"."agent_mcp_connections" "amc"
     JOIN "public"."agents" "a" ON (("amc"."agent_id" = "a"."id")))
...
ALTER TABLE "public"."agent_mcp_connection_logs" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."agent_mcp_connections" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "agent_mcp_connections_user_policy" ON "public"."agent_mcp_connections" USING (("agent_id" IN ( SELECT "agents"."id"
   FROM "public"."agents"
...
ALTER TABLE "public"."mcp_server_status_logs" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."agent_mcp_connection_logs" TO "anon";
GRANT ALL ON TABLE "public"."agent_mcp_connection_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."agent_mcp_connection_logs" TO "service_role";
...
GRANT ALL ON TABLE "public"."mcp_server_status_logs" TO "anon";
GRANT ALL ON TABLE "public"."mcp_server_status_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."mcp_server_status_logs" TO "service_role";
