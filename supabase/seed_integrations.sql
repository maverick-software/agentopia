-- Seed script for integrations data
-- This populates the integration_categories and integrations tables
...
SELECT 'Categories inserted:' as info, COUNT(*) as count FROM integration_categories;
SELECT 'Integrations inserted:' as info, COUNT(*) as count FROM integrations;
SELECT 'Gmail integration:' as info, name FROM integrations WHERE name = 'Gmail'; 