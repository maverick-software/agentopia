-- Quick fix for missing get_integration_categories_with_counts function
...
AS $$
BEGIN
    -- Return basic category data based on service_providers
    RETURN QUERY
    SELECT 
        ...
        COALESCE((
            ...
            WHERE (p_user_id IS NULL OR uic.user_id = p_user_id)
